...
public class MemoryPool
{
    ...
    private int increaseCount = 5;      //오브젝트가 부족할때 instantiate()로 추가 생성되는 오브젝트 개수
    ...
    public int ActiveCount => activeCount;//외부에서 현재 활성화 되어 잇는 오브젝트 개수 확인을 위한 프로퍼티
    ...
    public void InstantiateObject()
    {
        ...
        for(int i = 0; i < increaseCount; ++ i)
        {
            ...
            poolItem.isActive = false; //바로 사용하지 않을 수 있기 때문에 false 로 설정
    ...
    /// <summary>
    /// poolItemList에 저장되어 있는 오브젝트를 활정화해서 사용
